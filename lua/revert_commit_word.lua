...
local T = {}
local SendKeyCode = require("sendKeyCode")
...
function T.init(env)
    ...
    env.STACK_SIZE = 10 -- 定义栈大小，表示可以连续撤回的最大次数

    env.stack = create_stack(env.STACK_SIZE) -- 创建长度为10的栈
